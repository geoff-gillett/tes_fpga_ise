...
measurement_overflow_TB = {
    'trace': File('traces', np.dtype([('raw', np.int16), ('filtered', np.int16), ('slope', np.int16)]), True, True),
    'raw': File('raw', np.dtype([('index', np.int32), ('area', np.int32), ('extrema', np.int16)]), True, True),
    'filtered': File('filtered', np.dtype([('index', np.int32), ('area', np.int32), ('extrema', np.int16)]), True, True),
    'slope': File('slope', np.dtype([('index', np.int32), ('area', np.int32), ('extrema', np.int16)]), True, True),
    'pulse': File('pulse', np.dtype([('index', np.int32), ('area', np.int32), ('extrema', np.int16)]), True, True ),
