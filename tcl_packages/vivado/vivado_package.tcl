...
proc ::vivado::Create_simset {TB_file} { 
...
proc ::vivado::Process_IP_cores {IP_coresDir} {
...
proc ::vivado::Process_deps {projname buildDir scriptsDir} {
...
proc ::vivado::build_bitstream {top  synth implementation} {
...
proc ::vivado::process_simdir {simDir projname buildDir} {
	# add linkfiles file
	#handle structural
...
proc ::vivado::create_projects {name {sourceDir "../"} {buildDir "../"} args} { 
	set scriptsDir [pwd]
