...
In the NIST (ref) near IR TES, all three roles are fullfilled by a thin film of
Tungsten held in the quantum phase trasition between the normal and
superconducting states. The electron subsystem in the tungsten acts as
both absorber and thermometer and phonons weakly couple the electrons to the
tungstem (atomic?) latice which provides the cold bath. 

As thin film tungsten is a type II superconductor and its phase diagram displays
two critical magnetic fields (or equivilently currents).  
